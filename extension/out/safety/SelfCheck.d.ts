...
export declare function setGuardGitManager(mgr: GuardGitManager | null): void;
/** GuardGitManager 인스턴스 조회 */
export declare function getGuardGitManager(): GuardGitManager | null;
export declare class SelfChecker {
    ...
    /** Git Guard 무결성 진단 */
    checkGitGuardIntegrity(): Promise<SelfCheckItem>;
    /** 감지된 문제 자동 복구 시도 */
