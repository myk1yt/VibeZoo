...
class FixLoopManager {
    ...
    markBuildFailed(diagnostics, stderr) {
        ...
        if (guardMode === 'active') {
            ...
            this.writeFixRequest();
            this.updateStatusBar();
            StatusBarManager_1.NotificationThrottle.showWarning(`⚠️ VibeZoo: I_instability=${instability.toFixed(2)} (Guard: Active). Auto-Fix를 중단합니다. 수동 확인이 필요합니다.`);
